...
function SnipeMerchant()
    ...
    SummerItem:Cheat("Dropdown", "Select Item Summer",function(pornname)
        ...
        saveSettings()
    end, { options = {"capsule_summer"}, default = getgenv().portalnameC})
...
function autoload()
    pcall(function()
        ...
        if exec == "Synapse X" and Settings.AutoLoadScript then
            syn.queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/CatUwUKitty/CPUsaver/main/Anime_Adventures.lua'))()")
        elseif exec ~= "Synapse X" and Settings.AutoLoadScript then
            queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/CatUwUKitty/CPUsaver/main/Anime_Adventures.lua'))()")
        elseif exec ~= "Synapse X" and Settings.AutoLoadScript then
            syn.queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/CatUwUKitty/CPUsaver/main/Anime_Adventures.lua'))()")
        end
    end)
...
function autoload2()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/CatUwUKitty/CPUsaver/main/Anime_Adventures.lua'))()
end
